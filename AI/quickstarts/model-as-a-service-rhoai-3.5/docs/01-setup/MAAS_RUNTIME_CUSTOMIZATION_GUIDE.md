...
**Option 1**: Follow the [Platform Customization Guide](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/01-setup/MAAS_PLATFORM_CUSTOMIZATION_GUIDE.md) (30 minutes)

**Option 2**: Quick platform deployment if already familiar:
```bash
# Deploy platform components
helm install maas-platform \
  AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/maas-platform/ \
...
**Platform not configured?** Complete the [Platform Customization Guide](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/01-setup/MAAS_PLATFORM_CUSTOMIZATION_GUIDE.md) first, then return here.
...
**Chart Location:** `AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/maas-runtime/`
...
1. **Create a custom values file** (recommended):
   ```bash
   cp AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/maas-runtime/values.yaml my-values.yaml
   ```
...
3. **Install using the installation script**:
   ...
   ```bash
   helm install maas-runtime \
     AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/maas-runtime \
     -f my-values.yaml \
     --timeout 20m
   ```
...
1. **Deploy models**: See [DEPLOYING_MODEL_SERVICES.md](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/03-model-deployment/DEPLOYING_MODEL_SERVICES.md)
2. **Configure Model Registry**: See [ADDING_MODELS_TO_REGISTRY.md](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/02-model-catalog-and-registry/ADDING_MODELS_TO_REGISTRY.md)
3. **Set up workbenches**: See [WORKBENCH_STORAGE_GUIDE.md](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/GETTING_STARTED.md)
4. **Add models to registry**: See [ADDING_MODELS_TO_REGISTRY.md](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/02-model-catalog-and-registry/ADDING_MODELS_TO_REGISTRY.md)

## References

- [MaaS Platform Documentation](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/README.md)
- [Getting Started Guide](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/GETTING_STARTED.md)
- [Operators Guide](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/01-setup/MAAS_OPERATORS_GUIDE.md)
- [Platform Customization Guide](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/docs/01-setup/MAAS_PLATFORM_CUSTOMIZATION_GUIDE.md)
