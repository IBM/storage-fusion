...
For the ArgoCD `AppProject` and `Application` manifests that deploy this chart, see [`../../gitops/model-deploy-vllm-cpu/`](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/gitops/model-deploy-vllm-cpu).

---

## Deployed Models

See [`../../gitops/model-deploy-vllm-cpu/README.md`](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/gitops/model-deploy-vllm-cpu/README.md) for the full model table with ArgoCD Application names, S3 paths, and per-environment namespaces.
...
- [`maas-cpu-vs-gpu-capabilities.md`](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/infoDocs/maas-cpu-vs-gpu-capabilities.md) — Full CPU vs GPU capability matrix
- [`maas-model-deploy`](https://github.com/IBM/storage-fusion/blob/master/AI/quickstarts/model-as-a-service-rhoai-3.5/deploy/helm/maas-model-deploy/README.md) — GPU / LLMInferenceService chart (MaaS-publishable)
