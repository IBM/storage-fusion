...
#   CLUSTER_ID               - Short cluster id, e.g. f73l056
#   CLUSTER_DOMAIN           - Full domain, e.g. f73l056.fusion.tadn.ibm.com
...
#   STORAGE_CLASS            - Storage class (default: ocs-storagecluster-cephfs)
...
#   export CLUSTER_ID="f73l056"
#   export CLUSTER_DOMAIN="f73l056.fusion.tadn.ibm.com"
#   ./02-register-proxy-cluster.sh
#
...
# ── Defaults ───────────────────────────────────────────────────────────────────
CLUSTER_ID="${CLUSTER_ID:-f73l056}"
CLUSTER_DOMAIN="${CLUSTER_DOMAIN:-${CLUSTER_ID}.fusion.tadn.ibm.com}"
...
STORAGE_CLASS="${STORAGE_CLASS:-ocs-storagecluster-cephfs}"
