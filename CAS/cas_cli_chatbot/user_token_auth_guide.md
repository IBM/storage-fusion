...
keycloak_url: "http://10.48.116.171:8080/realms/master/protocol/openid-connect/token"
client_id: "myapp"
client_secret: "65I1F7BFDhM12BJx5NbF2FZFX7rx7fSX"
...
```bash
# Test with curl
curl -X POST "http://10.48.116.171:8080/realms/master/protocol/openid-connect/token" \
