...
class ConfigLoader:
    ...
    REQUIRED_FIELDS = ["console_url", "oc_username", "oc_password"]
    ...
    def _substitute_env_vars(self, config: dict[str, Any]) -> dict[str, Any]:
        ...
        return cast(dict[str, Any], substitute(config))
    ...
    def save(self, config: dict[str, Any], backup: bool = True) -> None:
        """
    ...
    def create_sample_config(output_path: Path) -> None:
        ...
        sample_config = {
            ...
            "session": {"file": "session_history.json", "auto_save": True},
            "metrics": {"max_samples": DEFAULT_METRICS_MAX_SAMPLES},
            "allow_self_signed": True,
        }
