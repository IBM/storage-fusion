...
class HealthChecker:
    ...
    def run_all_checks(self) -> dict[str, dict[str, Any]]:
        ...
        checks = [
            ...
            ("vector store", self.check_vector_store_service),
    ...
    def check_vector_store_service(self) -> dict[str, Any]:
        """Check vector store service"""
        vector_store_service = self.services.get("vector store")
        ...
        try:
            ...
            return self._healthy(f"Fetched {len(vector_stores)} vector stores from {namespace}")
        except Exception as e:
    ...
    def check_oc_cli(self) -> dict[str, Any]:
        ...
        try:
            result = subprocess.run(["oc", "version"], capture_output=True, timeout=5)
