...
import pytest
from chatbot.services.auth_service import (
    AuthenticationError,
    AuthService,
    ConfigurationError,
)
...
class TestAuthServiceConfiguration:
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_missing_username_raises_error(
        self: Any, mock_logger: Any, mock_cache_service: Any
    ) -> None:
    ...
    def test_missing_password_raises_error(
        ...
        config: dict[str, str] = {"oc_username": "test-user", "console_url": "https://console.test.com"}
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_missing_console_url_raises_error(
        self: Any, mock_logger: Any, mock_cache_service: Any
    ) -> None:
        """TC-AUTH-003: Verify authentication fails when console_url is missing"""
        config: dict[str, str] = {"oc_username": "test-user", "oc_password": "test-password"}
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_multiple_missing_fields_error_message(
        self: Any, mock_logger: Any, mock_cache_service: Any
    ) -> None:
...
class TestAuthServiceAPIURL:
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_correct_api_url_extraction(
        self: Any,
        ...
        auth_service = AuthService(sample_config, mock_logger, mock_cache_service)
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_invalid_console_url_no_hostname(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_cache_service: Any,
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_unsupported_console_url_format(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_cache_service: Any,
...
class TestAuthServiceAuthentication:
    ...
    @pytest.mark.auth
    @patch("chatbot.services.auth_service.subprocess.run")
    def test_bearer_token_retrieved_after_login(
        self: Any,
        mock_run: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
    ...
    @pytest.mark.auth
    @patch("chatbot.services.auth_service.subprocess.run")
    def test_token_expiry_set_after_authentication(
        self: Any,
        mock_run: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        assert auth_service.token_expiry <= after_auth + timedelta(hours=24, minutes=1)

    @pytest.mark.unit
    @pytest.mark.auth
    def test_cached_token_used_when_valid(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_cache_service: Any,
...
class TestAuthServiceTokenManagement:
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_has_valid_token_returns_true_when_valid(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_cache_service: Any,
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_has_valid_token_returns_false_when_expired(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_cache_service: Any,
    ...
    @pytest.mark.auth
    @patch("chatbot.services.auth_service.subprocess.run")
    def test_token_cached_in_cache_service(
        self: Any,
        mock_run: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
    ...
    @pytest.mark.unit
    @pytest.mark.auth
    def test_get_token_info_returns_correct_status(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_cache_service: Any,
...
class TestAuthServiceLogout:
    ...
    @pytest.mark.auth
    @patch("chatbot.services.auth_service.subprocess.run")
    def test_logout_clears_bearer_token(
        self: Any,
        mock_run: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
    ...
    @pytest.mark.auth
    @patch("chatbot.services.auth_service.subprocess.run")
    def test_logout_clears_token_expiry(
        self: Any,
        mock_run: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
