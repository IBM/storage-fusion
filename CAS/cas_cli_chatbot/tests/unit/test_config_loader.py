...
class TestConfigLoaderInitialization:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_config_loader_initializes(self: Any, tmp_path: Any) -> None:
...
class TestConfigLoaderLoad:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_load_valid_config(self: Any, tmp_path: Any) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_load_nonexistent_file_raises_error(self: Any, tmp_path: Any) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_load_empty_file_raises_error(self: Any, tmp_path: Any) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_load_invalid_yaml_raises_error(self: Any, tmp_path: Any) -> None:
...
class TestConfigLoaderValidation:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_validate_passes_for_valid_config(self: Any, tmp_path: Any) -> None:
        ...
        result: bool = loader.validate(config)

        assert result is True

    @pytest.mark.unit
    @pytest.mark.config
    def test_validate_fails_for_missing_required_field(
        self: Any, tmp_path: Any
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_validate_fails_for_invalid_console_url(
        self: Any, tmp_path: Any
    ) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_validate_fails_for_invalid_log_level(self: Any, tmp_path: Any) -> None:
...
class TestConfigLoaderEnvironmentVariables:
    ...
    def test_substitute_env_vars(self: Any, tmp_path: Any) -> None:
        ...
        loader = ConfigLoader(config_path)
        config: dict[str, Any] = loader.load()
    ...
    def test_substitute_env_vars_with_default(self: Any, tmp_path: Any) -> None:
...
class TestConfigLoaderDefaults:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_apply_defaults_for_missing_fields(self: Any, tmp_path: Any) -> None:
...
class TestConfigLoaderSave:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_save_config_to_file(self: Any, tmp_path: Any) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_save_creates_backup(self: Any, tmp_path: Any) -> None:
        """TC-CFG-014: Verify save creates backup when requested"""
        config_path = tmp_path / "config.yaml"
        backup_path = tmp_path / "config.yaml.bak"

        # Create initial config
        config_data: dict[str, str] = {"key": "old_value"}
        with open(config_path, "w") as f:
            yaml.dump(config_data, f)

        loader = ConfigLoader(config_path)
        new_config: dict[str, str] = {"key": "new_value"}
...
class TestConfigLoaderReload:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_reload_returns_fresh_config(self: Any, tmp_path: Any) -> None:
        ...
        config2: dict[str, Any] = loader.reload()
...
class TestConfigLoaderSampleConfig:
    ...
    @pytest.mark.unit
    @pytest.mark.config
    def test_create_sample_config(self: Any, tmp_path: Any) -> None:
