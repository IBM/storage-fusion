...
class TestQueryServiceTokenValidation:
    ...
    def test_query_fails_when_auth_service_not_available(
        self: Any, sample_config: dict[str, Any], mock_logger: Any
    ) -> None:
        """TC-QUERY-001: Verify query fails when auth service is not available"""
        query_service = QueryService(sample_config, mock_logger, auth_service=None)

        result: dict[str, Any] = query_service.query_vector_store("test query")
    ...
    @pytest.mark.unit
    @pytest.mark.query
    def test_query_fails_when_bearer_token_invalid(
        self: Any,
        ...
        query_service = QueryService(
            sample_config, mock_logger, auth_service=mock_auth_service
        )
    ...
    def test_query_proceeds_when_bearer_token_valid(
        self: Any,
        mock_post: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_auth_service: Any,
        mock_requests_response: Any,
    ) -> None:
...
class TestQueryServiceVectorStoreQueries:
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.post")
    def test_successful_query_to_vector_store(
        self: Any,
        mock_post: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        result: dict[str, Any] = query_service.query_vector_store(
            "test query", vector_store="test-vs", limit=5
        )
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.post")
    def test_error_handling_for_invalid_vector_store(
        self: Any,
        mock_post: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        result = query_service.query_vector_store(
            "test query", vector_store="invalid-vs"
        )
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.post")
    def test_error_handling_for_network_failures(
        self: Any,
        mock_post: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
...
class TestQueryServiceFilteredQueries:
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.post")
    def test_query_with_filters_executes_successfully(
        self: Any,
        mock_post: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        result: dict[str, Any] = query_service.query_with_filters(
            "test query", filters, vector_store="test-vs"
        )
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.post")
    def test_filters_properly_formatted_in_request(
        self: Any,
        mock_post: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        query_service.query_with_filters("test query", filters, vector_store="test-vs")
...
class TestQueryServiceVectorStoreManagement:
    ...
    def test_list_vector_stores_returns_all_available(
        self: Any,
        mock_get: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        mock_response.json.return_value = {
            "data": [{"name": vs} for vs in sample_vector_stores]
        }
        mock_response.raise_for_status = Mock()
        ...
        result: list[str] = query_service.list_vector_stores(use_cache=False)
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.get")
    def test_vector_store_list_cached(
        self: Any,
        mock_get: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.get")
    def test_empty_list_when_no_vector_stores(
        self: Any,
        mock_get: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
...
class TestQueryServiceFileContent:
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.get")
    def test_get_file_content_retrieves_for_valid_file(
        self: Any,
        mock_get: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        result: dict[str, Any] = query_service.get_file_content("vs-123", "file-456")
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.get")
    def test_error_handling_for_invalid_vector_store_id(
        self: Any,
        mock_get: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        result: dict[str, Any] = query_service.get_file_content("invalid-vs", "file-123")
    ...
    @pytest.mark.query
    @patch("chatbot.services.query_service.requests.get")
    def test_error_handling_for_invalid_file_id(
        self: Any,
        mock_get: Mock,
        sample_config: dict[str, Any],
        mock_logger: Any,
        ...
        result: dict[str, Any] = query_service.get_file_content("vs-123", "invalid-file")
...
class TestQueryServiceCacheManagement:
    ...
    @pytest.mark.unit
    @pytest.mark.query
    def test_clear_cache_removes_query_entries(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_auth_service: Any,
    ...
    @pytest.mark.unit
    @pytest.mark.query
    def test_statistics_include_cache_info(
        self: Any,
        sample_config: dict[str, Any],
        mock_logger: Any,
        mock_auth_service: Any,
        ...
        stats: dict[str, Any] = query_service.get_statistics()
