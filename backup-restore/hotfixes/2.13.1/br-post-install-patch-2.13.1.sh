#!/bin/bash
# Run this script on hub and spoke clusters to apply the latest hotfixes for 2.13.1 release.
patch_usage() {
...
IMAGE_SOURCE="br-2.13.1patch-offline-mirror.sh"
  ...
  -p '[
    {
      ...
      "value": "{\"properties\":[{\"type\":\"olm.gvk\",\"value\":{\"group\":\"dataprotectionagent.idp.ibm.com\",\"kind\":\"DataProtectionAgent\",\"version\":\"v1\"}},{\"type\":\"olm.package\",\"value\":{\"packageName\":\"ibm-dataprotectionagent\",\"version\":\"2.13.1\"}},{\"type\":\"olm.package.required\",\"value\":{\"packageName\":\"guardian-dm-operator\",\"versionRange\":\"\u003e=2.13.1-1\"}},{\"type\":\"olm.package.required\",\"value\":{\"packageName\":\"guardian-dp-operator\",\"versionRange\":\"\u003e=2.13.1-1\"}},{\"type\":\"olm.package.required\",\"value\":{\"packageName\":\"redhat-oadp-operator\",\"versionRange\":\"\u003e=1.4.1 \u003c1.7.0 !1.4.11\"}}]}"
    }
  ]'
