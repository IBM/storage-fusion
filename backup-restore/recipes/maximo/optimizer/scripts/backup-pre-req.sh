...
oc label -n $OPTIMIZER_NAMESPACE operatorgroup mas-${MAS_INSTANCE_ID}-optimizer-operator-group for-backup=true
oc label -n $OPTIMIZER_NAMESPACE subscription ibm-mas-optimizer for-backup=true
...
oc get -n $OPTIMIZER_NAMESPACE --show-labels operatorgroup mas-${MAS_INSTANCE_ID}-optimizer-operator-group
oc get -n $OPTIMIZER_NAMESPACE --show-labels subscription ibm-mas-optimizer
